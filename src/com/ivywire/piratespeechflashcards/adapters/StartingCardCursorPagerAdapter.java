...
public class StartingCardCursorPagerAdapter extends PagerAdapter{
	...
	public StartingCardCursorPagerAdapter(Context context, Cursor cursor){
		this.cursor = cursor;
	...
	public Object instantiateItem(View view, int position) {
		...
		else if(position > 1 && position < 62){
			position2--;
		    cursor.moveToPosition(position2);
		    layout = (RelativeLayout) inflater.inflate(R.layout.activity_card, null);
		    layout.setBackgroundResource(R.drawable.card_starting);
